...
public class RhythmManager : MonoBehaviour
{
    ...
    Due to this i've changed the folder structure and these parameters only need the file name, rather than path */
    ...
    public static bool OnBeatPerfect(Beat beat)
    {
    ...
    private void InvokeEventOnBeat()
    {
    ...
    {
        SongDeltaTime = songPosition - lastSongPosition;
        TimeSinceLastBeat = songPosition - (activeSong.beatLengthInSeconds * currentBeat);
